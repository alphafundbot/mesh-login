...
export default function MeshVisualizer3D() {
  ...
  useEffect(() => {
    ...
    animate(); // Call once on mount

    // Optionally, periodically update
    // const interval = setInterval(animate, 10000);

    // Animation loop (if you want continuous rendering)
    // const renderLoop = () => {
    //   renderer.render(scene, camera);
    ...
    return () => {
      // clearInterval(interval); // Uncomment if you use setInterval
